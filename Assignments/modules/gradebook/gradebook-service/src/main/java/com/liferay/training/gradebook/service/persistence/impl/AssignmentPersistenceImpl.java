...
import com.liferay.training.gradebook.service.persistence.impl.constants.AssignmentsPersistenceConstants;
...
public class AssignmentPersistenceImpl
	...
	public Assignment updateImpl(Assignment assignment) {
		...
		if (isNew) {
			Object[] args = new Object[] {assignmentModelImpl.getGroupId()};
	...
	@Override
	@Reference(
		target = AssignmentsPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = AssignmentsPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	static {
		try {
			Class.forName(AssignmentsPersistenceConstants.class.getName());
		}
