...
/**
 * The base model implementation for the Assignment service. Represents a row in the &quot;Assignments_Assignment&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class AssignmentModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Assignments_Assignment";
	...
	public static final String TABLE_SQL_CREATE =
		"create table Assignments_Assignment (assignmentId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title VARCHAR(75) null,description VARCHAR(75) null,dueDate DATE null)";

	public static final String TABLE_SQL_DROP =
		"drop table Assignments_Assignment";

	public static final String ORDER_BY_JPQL = " ORDER BY assignment.title ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Assignments_Assignment.title ASC";
