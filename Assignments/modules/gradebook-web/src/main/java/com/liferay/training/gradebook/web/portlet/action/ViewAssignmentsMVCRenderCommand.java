...
@Component(immediate = true, property = { "javax.portlet.name=" + GradebookPortletKeys.GRADEBOOK, "mvc.command.name=/",
		"mvc.command.name=" + MVCCommandNames.VIEW_ASSIGNMENTS },

		service = MVCRenderCommand.class)

public abstract class ViewAssignmentsMVCRenderCommand implements MVCRenderCommand {
	 ...
	 */
	 ...
	 AssignmentsManagementToolbarDisplayContext assignmentsManagementToolbarDisplayContext =
	      new AssignmentsManagementToolbarDisplayContext( liferayPortletRequest, liferayPortletResponse, 
	 ...
	 @Reference
	 protected AssignmentLocalService _assignmentService;
	 @Reference
