...
public class AssignmentLocalServiceUtil {
	...
	public static com.liferay.training.gradebook.model.Assignment
			updateAssignment(
				long groupId, String title, long assignmentId,
				String description, Date dueDate, ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().updateAssignment(
			groupId, title, assignmentId, description, dueDate, serviceContext);
	}
